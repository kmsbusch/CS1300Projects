...
class Library
{
    ...
    public:
        ...
        string viewRatings(string); //Takes string (username) & prints all books a user has provided ratings for.
    ...
    private:
        ...
        Book books[50]; //An array of Book objects. Is it best to put the number in here bc I know the size already?
        User users[100]; //An array of User objects. same question as above
