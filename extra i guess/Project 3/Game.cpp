...
Player Game::startMenu(){
    ...
    // 	int agility = 10;
    	...
    	{
    	    cout << "Humans have a good overall build, with 10 strength and 8 intelligence, and 100 health to start with. Elves start with less health at 85, but their strength and intelligence is a 12." << endl;
    	    cout << "---------------------------------------" << endl;
    	}
    	else
    	{
